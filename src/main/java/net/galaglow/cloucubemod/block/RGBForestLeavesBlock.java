...
public class RGBForestLeavesBlock extends CloucubemodModElements.ModElement {
	@ObjectHolder("cloucubemod:rgb_forest_leaves")
	public static final Block block = null;
	public RGBForestLeavesBlock(CloucubemodModElements instance) {
		super(instance, 13);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("rgb_forest_leaves");
		}
