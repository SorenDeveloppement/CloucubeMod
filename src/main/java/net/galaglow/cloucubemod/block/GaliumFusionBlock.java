...
public class GaliumFusionBlock extends CloucubemodModElements.ModElement {
	@ObjectHolder("cloucubemod:galium_fusion")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("cloucubemod:galium_fusion_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public GaliumFusionBlock(CloucubemodModElements instance) {
		super(instance, 5);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("cloucubemod:blocks/galblock"), new ResourceLocation("cloucubemod:blocks/galblock"))
						.luminosity(0).density(100000).viscosity(100000)).bucket(() -> bucket).block(() -> block);
		still = (FlowingFluid) new ForgeFlowingFluid.Source(fluidproperties).setRegistryName("galium_fusion");
		flowing = (FlowingFluid) new ForgeFlowingFluid.Flowing(fluidproperties).setRegistryName("galium_fusion_flowing");
		elements.blocks.add(() -> new FlowingFluidBlock(still, Block.Properties.create(Material.WATER)) {
		}.setRegistryName("galium_fusion"));
		elements.items
				.add(() -> new BucketItem(still, new Item.Properties().containerItem(Items.BUCKET).maxStackSize(1).group(CloucubeModItemGroup.tab))
						.setRegistryName("galium_fusion_bucket"));
	}
